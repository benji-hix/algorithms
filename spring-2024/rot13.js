...
function rot13(message) {
    const alphabet = "abcdefghijklmnopqrstuvwxyzABCDEFHIJKLMNOPQRSTUVQXYZ"
    const rot13Alphabet = "nopqrstuvwxyzabcdefghijklmNOPQRSTUVQXYZABCDEFHIJKLM"
    return message.replace(/[a-zA-Z]/g, (character) => {
        return rot13Alphabet[alphabet.indexOf(character)]
    })
}
